            ...
            <div id="form">
                <table>
                    ...
                    while($r1=$q->fetch(PDO::FETCH_OBJ))
                    {
                        ?>
                    <tr>
                         <td><center><?=$r1->did; ?></center></td>
                         <td><center><?=$r1->dname; ?></center></td>
                         <td><center><?=$r1->dfname;?></center></td>
                         <td><center><?=$r1->daddress;?></center></td>
                         <td><center><?=$r1->dcity;?></center></td>
                         <td><center><?=$r1->dage;?></center></td>
                         <td><center><?=$r1->dbgroup;?></center></td>
                         <td><center><?=$r1->dmno;?></center></td>
