            ...
            <div id="form" style="height:450px;position:absolute;">
                <table>
                    ...
                    <tr>
                         ...
                         <td><center>
                            <?php
                            $q=$db->query("SELECT * FROM donor_registration  WHERE dbgroup='A+'");
                             echo $row=$q->rowcount();
                            ?>
                    ...
                    <tr>
                         ...
                         <td><center>
                         <?php
                            $q=$db->query("SELECT * FROM donor_registration WHERE dbgroup='B+'");
                             echo $row=$q->rowcount();
                            ?>
                         </center></td>
                    </tr>
                    ...
                    <tr>
                         ...
                         <td><center>
                         <?php
                            $q=$db->query("SELECT * FROM donor_registration WHERE dbgroup='AB+'");
                             echo $row=$q->rowcount();
                            ?>
                         </center></td>
                    </tr>
                    ...
                    <tr>
                         ...
                         <td><center>
                         <?php
                            $q=$db->query("SELECT * FROM donor_registration WHERE dbgroup='O+'");
                             echo $row=$q->rowcount();
                            ?>
                         </center></td>
                    </tr>
